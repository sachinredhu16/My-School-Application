...
/*  @ControllerAdvice(annotations = Conditional.class) using this with controller tells that this exception logic will executed when
    exception is come from Controller not from RestController */
